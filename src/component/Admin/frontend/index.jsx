...
function Frontend() {
    ...
    const [inputs, setInputs] = useState({
                id:  config.CATEGORIES.TYPE_FRONTEND,
                keyworks: '',
                category: '',
                status: '',
                page: 1
            ...
            render: function(data){
                return (
                    <span className="icon-not-text padding-top-6 text-center">
                        <Link to={config.PATH_ADMIN + 'frontend-edit/' + data.id} className="right-100">
    ...
    useEffect(() => {
        dispatch(categoriesAction.getCategory(config.CATEGORIES.TYPE_FRONTEND));
    }, [])
                ...
                <div className="animated fadeIn">
                    <div className="row">
                        ...
                        <div className="col-sm-12 col-md-12 bottom-20">
                            <Link to={config.PATH_ADMIN + 'frontend-form'} className="right-100">
