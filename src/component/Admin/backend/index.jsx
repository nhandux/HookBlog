...
function Backend() {
    ...
    const [inputs, setInputs] = useState({
                id:  config.CATEGORIES.TYPE_BACKEND,
                keyworks: '',
                category: '',
                status: '',
                page: 1
            ...
            render: function(data){
                return (
                    <span className="icon-not-text padding-top-6 text-center">
                        <Link to={config.PATH_ADMIN + 'backend-edit/' + data.id} className="right-100">
    ...
    useEffect(() => {
        dispatch(categoriesAction.getCategory(config.CATEGORIES.TYPE_BACKEND));
    }, [])
                ...
                <div className="animated fadeIn">
                    <div className="row">
                                        ...
                                        <div className="el-loading-demo">
                                            <div className="row">
                                                ...
                                                <div className="col-md-4">
                                                    <Select value={valueParent} name="category" placeholder="Category" onChange={(e) => handleChange(e, 'category')}>
                                                        {
                                                        options.map(el => {
                                                ...
                                                <div className="col-md-4">
                                                    <Select value={valueParent} name="status" placeholder="Status" onChange={(e) => handleChange(e, 'status')}>
                                                        {
                                                        status.map(el => {
                        ...
                        <div className="col-sm-12 col-md-12 bottom-20">
                            <Link to={config.PATH_ADMIN + 'backend-form'} className="right-100">
