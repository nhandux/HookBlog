...
function VideoForm() {
    ...
    useEffect(() => {
        dispatch(categoriesAction.getCategoryByPost(config.CATEGORIES.TYPE_VIDEO_TUT));
    ...
    const handleSubmit = (e) => {
        checkValidate()
            .then(() => {
                ...
                if(id)
                    dispatch(postAction.update(id, frmDatas, 'video-tut')); 
                else 
                    dispatch(postAction.insert(frmDatas, 'video-tut'));
            })
            .catch(errors => {
                Message({
                    message: errors,
    ...
    const handelDelete = () => {
        MessageBox.confirm('Are you want to delete item, sure?', '', {
            ...
            dispatch(postAction.deleteItem(id, {}, 'video-tut'));
        })
    }
                        ...
                        <div className="row">
                            <div className="col-sm-12 col-md-8">
                                {show && <div className="card">
                                    <div className="card-header"><i className="icon-chart"></i> Video Form
                                        ...
                                        <div className="card-body">
                                            <div className="el-loading-demo">
                                                <Form.Item label="Name">
                                                    <Input  onChange={(e) => handleChange(e, 'name')} value={frmDatas.name} placeholder="Video name"></Input>
                                                </Form.Item>
                                                <Form.Item label="Link">
                                                    <Input  onChange={(e) => handleChange(e, 'link')} value={frmDatas.link} placeholder="Video link"></Input>
                                                </Form.Item>
                                                ...
                                                <Form.Item label="Comment">
                                                    <Input type="textarea" onChange={(e) => handleChange(e, 'comment')} value={frmDatas.comment} placeholder="Video comment"></Input>
                                                </Form.Item>
